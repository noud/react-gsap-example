...
const SvgComponent = () => (
  <SvgStyled>
    ...
    <Controls>
      <Tween
        wrapper={
          <svg width="800" height="200" viewBox="250 -100 50 150" version="1.1" xmlns="http://www.w3.org/2000/svg" />
        }
        from={{
          svgDraw: 0,
        }}
